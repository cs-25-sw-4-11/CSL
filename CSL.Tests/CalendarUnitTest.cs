...
public class CalendarUnitTest
{
    ...
    // [TestCase("(11:00 || 12:00) ++ 'abc'")]
    public void TestCalendarConcat(string input)
    {
        var stream = CharStreams.fromString(input);
        var lexer = new CSLLexer(stream);
        ...
        Calendar expectedResult = new ([
            new (Subject: "abc", Duration: new Duration(0, 1)),
            new (Subject: "abc", Clock: new Clock(12, 0))]);
