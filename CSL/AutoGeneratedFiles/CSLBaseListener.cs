...
public partial class CSLBaseListener : ICSLListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMultiplyOp([NotNull] CSLParser.MultiplyOpContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMultiplyOp([NotNull] CSLParser.MultiplyOpContext context) { }
	/// <summary>
